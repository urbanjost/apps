...
**-percent REAL_VALUE** set threshold at which to report values as a
...
2.  GENERATE TRIAL DATA: When you port the procedures to another system
...
"cray_results.txt" and "cygwin_results.txt". To compare the values we
enter
...
see** how large a difference in value was found. Using **nd(1) you can**
