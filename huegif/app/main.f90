...
'@(#)COMPILED:       2023-06-10 22:03:00 UTC-240>',&
'']
...
use M_pixel,    only : centertext,  clear,     closepoly,  color,  draw2,     drawstr,  font,      linewidth
use M_pixel,    only : makepoly,    mapcolor,  move2,      page,   prefsize,  textang,  textsize,  vinit
