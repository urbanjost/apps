...
integer :: i
   ...
   ! write file playgroundsed to stdout
...
'limited ASCII characters, replacing them with one or more character triplets',&
'that consist of the percent character and a two-digit hexadecimal value.    ',&
'                                                                            ',&
'OPTIONS                                                                     ',&
