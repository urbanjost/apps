...
# SYNOPSIS
    ...
    sleep- [dd-hh:mm:ss[.xxx]|xxx.yyy[s|m|h|d]] [ -countdown|-countup -count]|--help|--version
...
:   how many seconds between counts when **-countdown and -countup** are
    specified. Values other than one may trim the total sleep time by up
    to COUNT seconds.
