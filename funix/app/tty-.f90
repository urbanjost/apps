...
'NAME                                                                                                                            ',&
'   tty-(1f) - [FUNIX:FILESYSTEM] print information about the file/terminal                                                      ',&
...
'   terminal connected to standard input. The results are dependent on                                                           ',&
'   the programming environment used, as some of the behavior is system                                                          ',&
'   dependent.                                                                                                                   ',&
'OPTIONS                                                                                                                         ',&
...
'   "stdin". Other compilers return a null filename, others return the                                                           ',&
'   name of the redirected file. What if there was actually a file called                                                        ',&
'   "stdin"?                                                                                                                     ',&
'                                                                                                                                ',&
'        tty- </dev/null                                                                                                         ',&
'        > for INPUT_UNIT=5                                                                                                      ',&
...
'@(#)COMPILED:       2022-06-27 07:23:55 UTC-240>',&
'']
